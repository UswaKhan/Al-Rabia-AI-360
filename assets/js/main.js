...
$(document).ready(function () {
	...
	//>>>> sponsor slider (logo scroller) - match testimonial Swiper
	var sponsorSwiper = new Swiper('.sponsor__wrap', {
	  loop: true,
	  speed: 3000,
	  autoplay: {
	    delay: 2000,
	...
	//>>>> Process section Swiper - match testimonial Swiper
...
// Ensure all process cards have equal height
function setEqualProcessCardHeights() {
  var cards = document.querySelectorAll('.process_swiper .process_item');
  var maxHeight = 0;
...
window.addEventListener('load', setEqualProcessCardHeights);
window.addEventListener('resize', setEqualProcessCardHeights);